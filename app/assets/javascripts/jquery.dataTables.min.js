...
this.oInstance=null;this.oFeatures={bPaginate:true,bLengthChange:true,bFilter:true,bSort:true,bInfo:true,bAutoWidth:true,bProcessing:false,bSortClasses:true,bStateSave:false,bServerSide:false,bDeferRender:false};this.oScroll={sX:"",sXInner:"",sY:"",bCollapse:false,bInfinite:false,iLoadGap:100,iBarWidth:0,bAutoCss:true};this.aanFeatures=[];this.oLanguage={sProcessing:"Processando...",sLengthMenu:"Mostar _MENU_ linhas",sZeroRecords:"Nenhum dado foi encontrado",sEmptyTable:"Nenhum dado cadastrado",
sLoadingRecords:"Carregando...",sInfo:"Mostrando de _START_ à _END_ de _TOTAL_",sInfoEmpty:"",sInfoFiltered:"(filtrados de _MAX_ dados)",sInfoPostFix:"",sInfoThousands:",",sSearch:"Buscar:",sUrl:"",oPaginate:{sFirst:"Primeira",sPrevious:"Anterior",sNext:"Próxima",sLast:"Última"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=[];this.aoColumns=[];this.aoHeader=[];this.aoFooter=[];this.iNextId=0;this.asDataSearch=[];this.oPreviousSearch={sSearch:"",
